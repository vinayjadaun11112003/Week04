package com.extract_currency_value_13;
import java.util.ArrayList;
import java.util.Scanner;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

//ExtractCurrencyValue --> This class is created for the extraction of currency value from the string.
public class ExtractCurrencyValue {
    ...
    //method which return the arraylist of type string after the extraction of currency value from string.
    ...
    public static void main(String[] args){
        boolean flag = true;
        String regex = "^[$]+{1}[0-9.]+";
        System.out.println(ANSI_CYAN+"EXTRACT CURRENCY VALUE FROM STRING SYSTEM(if you want to exit the program type 'exit')"+ANSI_RESET);
        while(flag) {
